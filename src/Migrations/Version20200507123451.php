 ...
 */
final class Version20200507123451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, quantity INT DEFAULT NULL, net_value NUMERIC(10, 2) DEFAULT NULL, gross_value NUMERIC(10, 2) DEFAULT NULL, vat INT NOT NULL, currency VARCHAR(20) NOT NULL, INDEX IDX_D34A04ADA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
