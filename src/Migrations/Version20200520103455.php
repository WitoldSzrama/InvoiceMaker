 ...
 */
final class Version20200520103455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, contact_email VARCHAR(40) DEFAULT NULL, name VARCHAR(40) NOT NULL, nip INT DEFAULT NULL, regon INT DEFAULT NULL, city VARCHAR(40) DEFAULT NULL, post_code VARCHAR(9) DEFAULT NULL, street VARCHAR(40) DEFAULT NULL, st_number VARCHAR(20) DEFAULT NULL, account_number VARCHAR(32) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, terms_accepted BOOLEAN NOT NULL, base_number INT DEFAULT NULL, base_currency VARCHAR(10) DEFAULT NULL, invoice_number_template VARCHAR(30) DEFAULT NULL, base_vat VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON users (email)');
        $this->addSql('CREATE TABLE company (id INT NOT NULL, user_id INT DEFAULT NULL, contact_email VARCHAR(40) DEFAULT NULL, name VARCHAR(40) NOT NULL, nip INT DEFAULT NULL, regon INT DEFAULT NULL, city VARCHAR(40) DEFAULT NULL, post_code VARCHAR(9) DEFAULT NULL, street VARCHAR(40) DEFAULT NULL, st_number VARCHAR(20) DEFAULT NULL, account_number VARCHAR(32) DEFAULT NULL, PRIMARY KEY(id))');
