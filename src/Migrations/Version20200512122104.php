 ...
 */
final class Version20200512122104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, contact_email VARCHAR(180) DEFAULT NULL, name VARCHAR(255) NOT NULL, nip INT DEFAULT NULL, regon INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, post_code VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, st_number VARCHAR(255) DEFAULT NULL, account_number VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, terms_accepted TINYINT(1) NOT NULL, base_number INT DEFAULT NULL, base_currency VARCHAR(10) DEFAULT NULL, invoice_number_template VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, contact_email VARCHAR(180) DEFAULT NULL, name VARCHAR(255) NOT NULL, nip INT DEFAULT NULL, regon INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, post_code VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, st_number VARCHAR(255) DEFAULT NULL, account_number VARCHAR(255) DEFAULT NULL, INDEX IDX_4FBF094FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
